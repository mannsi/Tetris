...
LBlock::LBlock(Point initial_top_left_world_point): Block(initial_top_left_world_point, Color(1,0,1)) {
    ...
    form1.form.push_back({false, true, false, false});
    form1.form.push_back({false, false, false, false});
    ...
    form3.form.push_back({false, false, false, true});
